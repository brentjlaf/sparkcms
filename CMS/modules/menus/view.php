    ...
    <div class="menu-dashboard" data-last-updated="<?php echo htmlspecialchars($lastUpdatedIso, ENT_QUOTES); ?>">
        <header class="a11y-hero menu-hero">
            <div class="a11y-hero-content">
                <div>
                    <h2 class="a11y-hero-title">Navigation Menus</h2>
                    <p class="a11y-hero-subtitle">Craft intuitive navigation experiences and keep every menu in sync with your site's structure.</p>
                </div>
        ...
        <div class="a11y-overview-grid menu-overview-grid">
            <div class="a11y-overview-card menu-overview-card">
                <div class="a11y-overview-value" id="menuStatTotal"><?php echo $totalMenus; ?></div>
                <div class="a11y-overview-label">Total Menus</div>
            </div>
            <div class="a11y-overview-card menu-overview-card">
                <div class="a11y-overview-value" id="menuStatLinks"><?php echo $totalLinks; ?></div>
                <div class="a11y-overview-label">Total Links</div>
            </div>
            <div class="a11y-overview-card menu-overview-card">
                <div class="a11y-overview-value" id="menuStatNested"><?php echo $menusWithNested; ?></div>
                <div class="a11y-overview-label">Menus with Submenus</div>
            </div>
            <div class="a11y-overview-card menu-overview-card">
                <div class="a11y-overview-value" id="menuStatAverage"><?php echo $averageLinks; ?></div>
                <div class="a11y-overview-label">Average Links per Menu</div>
            </div>
        </div>
