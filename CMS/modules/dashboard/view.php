            ...
            <div class="a11y-hero-content dashboard-hero-content">
                <div>
                    ...
                    <p class="a11y-hero-subtitle">
                        Monitor the health of your content, media, and events from one polished overview.
                    </p>
                </div>
        ...
        <section class="dashboard-panel dashboard-module-panel" aria-labelledby="dashboardSectionModules">
            <header class="dashboard-panel-header">
                <div>
                    ...
                    <p class="dashboard-panel-description">Understand where attention is needed across features like Events, Calendar, and more.</p>
                </div>
            </header>
